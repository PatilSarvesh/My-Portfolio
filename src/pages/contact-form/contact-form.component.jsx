      ...
      <Jumbotron className="contact-jumbotron">
        <Row>
          <Col className="d-flex justify-content-center flex-wrap">
            <div className="m-2">
              <a href="mailto:patilsarvesh1999@gmail.com" target="_blank" rel="noopener noreferrer">
                <Button variant="outline-danger" title="patilsarvesh1999@gmail.com">
            ...
            <div className="m-2">
              <a href="https://twitter.com/sarvesh_goudru" target="_blank" rel="noopener noreferrer">
